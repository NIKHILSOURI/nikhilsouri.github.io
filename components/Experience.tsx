      ...
      <div className="relative space-y-8 pl-4 sm:pl-0">
        ...
        {EXPERIENCE_DATA.map((exp, idx) => (
          ...
          >
            ...
            <div className="w-full sm:w-1/2 pl-10 sm:pl-12 md:pl-0">
                <div className={`bg-black/40 border border-white/10 p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl backdrop-blur-md hover:border-cyan-500/40 transition-all group ${idx % 2 === 0 ? 'sm:mr-4 md:mr-8' : 'sm:ml-4 md:ml-8'}`}>
                    <div className="flex justify-between items-start mb-2 gap-2">
                        <h3 className="text-base sm:text-lg md:text-xl font-orbitron font-bold text-white group-hover:text-cyan-400 transition-colors break-words">{exp.role}</h3>
                        {exp.link && (
